...
const styles = StyleSheet.create({
    ...
    formatText: { fontSize: 13, fontFamily: 'Inter_500Medium', alignSelf: 'center', marginBottom: -4 },
    textArea: { height: 300, borderWidth: 1, borderRadius: 16, padding: 16, fontSize: 15, fontFamily: 'Inter_400Regular' },
    ...
    uploadBtnText: { fontSize: 16, fontFamily: 'Inter_600SemiBold' },
    ...
    previewCard: { borderWidth: 1, borderRadius: 12, padding: 12, gap: 8 },
    cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    cardIndex: { fontSize: 12, fontFamily: 'Inter_600SemiBold' },
    cardFields: { gap: 8 },
    fieldRow: { flexDirection: 'row', gap: 8 },
    inlineInput: { flex: 1, fontSize: 16, fontFamily: 'Inter_600SemiBold', paddingVertical: 4, borderBottomWidth: 1 },
    inlineInputFull: { fontSize: 14, fontFamily: 'Inter_400Regular', paddingVertical: 4, borderBottomWidth: 1 },
    tagPreview: { fontSize: 12, fontFamily: 'Inter_500Medium', marginTop: 4 },
