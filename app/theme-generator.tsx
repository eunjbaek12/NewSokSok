...
export default function ThemeGeneratorScreen() {
  ...
  }, [results, theme, targetListId, createList, addBatchWords]);
        ...
        >
          ...
          <View style={styles.optionsSection}>
            ...
            >
              ...
              />
              <Text
                style={[styles.listPickerBtnText, { color: colors.text }]}
                numberOfLines={1}
              >
                {targetLabel}
              </Text>
          ...
          <View style={styles.chipsSection}>
            <View style={styles.chipsSectionHeader}>
              <Text style={[styles.chipsSectionTitle, { color: colors.text }]}>
                Popular Themes
              </Text>
