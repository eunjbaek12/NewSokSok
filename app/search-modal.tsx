...
const styles = StyleSheet.create({
    ...
    recommendTitle: { fontSize: 14, fontFamily: 'Inter_600SemiBold', marginBottom: 16 },
    tagWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
    recTagChip: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 24, gap: 6 },
    recTagText: { fontSize: 15, fontFamily: 'Inter_500Medium' },
    noTagsBox: { flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 100, gap: 12 },
    noTagsText: { fontSize: 15, fontFamily: 'Inter_400Regular' },
    resultsContent: { padding: 16, gap: 12 },
    resultCard: { padding: 16, borderRadius: 16, borderWidth: 1, gap: 6 },
    resultHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
    resultTerm: { fontSize: 18, fontFamily: 'Inter_700Bold' },
    listBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6, gap: 4, maxWidth: '50%' },
    listBadgeText: { fontSize: 11, fontFamily: 'Inter_500Medium' },
    resultMeaning: { fontSize: 15, fontFamily: 'Inter_500Medium' },
    tagMatchBadge: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, gap: 4, marginTop: 4 },
    tagMatchText: { fontSize: 11, fontFamily: 'Inter_600SemiBold' },
    tagsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 6 },
    smallTag: { fontSize: 12, fontFamily: 'Inter_500Medium', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, overflow: 'hidden' }
});
