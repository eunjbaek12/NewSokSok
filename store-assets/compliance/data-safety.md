...
**이름 (Name)**
- 수집 ✅ · 공유 ❌ · **필수**(소셜 로그인 시 자동 제공) · 임시처리 ❌
- 목적: 계정 관리, 앱 기능(큐레이션 공유자명 표시)
...
**사진 (Photos)**
- 수집 ✅ · **공유 ✅ (Google)** · **선택**(사진 스캔을 쓸 때만) · **임시처리 ✅**
- 목적: 앱 기능 (OCR 단어 추출)
...
- 수집 ✅ · 공유 ❌ · 목적: 앱 기능 · **로컬 저장만, 클라우드 동기화에 포함 안 됨**

**사용자 생성 콘텐츠 (Other user-generated content)**
- 수집 ✅ · **공유 ⚠️ 조건부** · 목적: 앱 기능, 개인화
- 단어·단어장·학습 결과·통계. 큐레이션 공유 기능을 쓰면 **다른 사용자에게 공개**되며,
  공유 여부는 사용자가 선택합니다.
...
**기기 또는 기타 ID**
- 수집 ✅ · **공유 ✅ (Google)** · 목적: **광고 또는 마케팅**, 고객 지원
- 두 가지입니다:
