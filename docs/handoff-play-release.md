...
> ⚠️ **구버전 (historical, v1.0 / 2026-05-15 기록).** 출시 진행 상태의 최신 기준은 **`handoff-launch-checklist.md`** 다. 이 문서는 v1.0 시점 기록이라 v1.1과 안 맞는 부분이 있다(예: "광고: 없음"). **환경/계정 메모와 빌드 명령**만 참고용으로 유효.
