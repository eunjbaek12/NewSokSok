...
- ~~«오늘 Day»를 무엇으로 셀지~~ → **9/17 Day 로 자르지 않기로 해서 단어 고르기엔 필요 없어졌다.**
  남은 것: **위젯에서 외운 게 홈 카드의 Day 진도(`planCurrentDay`)를 올릴지.** 지금 앱은 학습을 끝까지 마쳐야만 올린다 —
  «골라서 학습»으로 외울 때도 마찬가지라, 위젯이 안 올려도 새 어긋남은 아니다. 홈 카드가 바뀌는 일이라 위젯 스펙 때 그려서 정한다.
