...
> ⚠️ **구버전 (historical, 2026-05-22 기록).** 출시 진행 상태의 최신 기준은 **`handoff-launch-checklist.md`** 다. 이 문서의 완료/대기 표시는 작성 시점 기준이라 실제와 다를 수 있으니(예: AdMob·구독상품 상태) 상태 판단엔 쓰지 말고, v1.1 **구현 상세 참고용**으로만 사용할 것.
