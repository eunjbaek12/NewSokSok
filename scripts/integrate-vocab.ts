...
const META: Record<string, ListMeta> = {
  ...
  restaurant: {
    ...
    tags: ['Korean', 'Restaurant', 'Daily Life'],
    sourceLanguage: 'ko',
    targetLanguage: 'en',
  },
  travel: {
  ...
  ceremony: {
    ...
    tags: ['Korean', 'Culture', 'Daily Life'],
    sourceLanguage: 'ko',
    targetLanguage: 'en',
  },
  hangul: {
