...
Each item:
{
  ...
  "exampleZh": "Natural advanced Chinese sentence (10-20 characters) in simplified characters using the term. HSK 5 grammar (e.g. 不仅…而且…, 即使…也…, 无论…都…, 既然…就…, 通过…来…, 由…组成, formal/written register).",
